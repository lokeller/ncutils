...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Release.mk dist/Release/GNU-Linux-x86/ncutilsc

dist/Release/GNU-Linux-x86/ncutilsc: ${OBJECTFILES}
...
${OBJECTDIR}/finite_field.o: nbproject/Makefile-${CND_CONF}.mk finite_field.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/finite_field.o finite_field.c

${OBJECTDIR}/coding_vector_decoder.o: nbproject/Makefile-${CND_CONF}.mk coding_vector_decoder.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/coding_vector_decoder.o coding_vector_decoder.c

${OBJECTDIR}/packet_decoder.o: nbproject/Makefile-${CND_CONF}.mk packet_decoder.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/packet_decoder.o packet_decoder.c

${OBJECTDIR}/uncoded_packet.o: nbproject/Makefile-${CND_CONF}.mk uncoded_packet.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/uncoded_packet.o uncoded_packet.c

${OBJECTDIR}/coded_packet.o: nbproject/Makefile-${CND_CONF}.mk coded_packet.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/coded_packet.o coded_packet.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/GNU-Linux-x86/ncutilsc
