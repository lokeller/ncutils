...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Coverage.mk dist/Coverage/GNU-Linux-x86/ncutilsc

dist/Coverage/GNU-Linux-x86/ncutilsc: ${OBJECTFILES}
	${MKDIR} -p dist/Coverage/GNU-Linux-x86
	${LINK.c} -coverage -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ncutilsc ${OBJECTFILES} ${LDLIBSOPTIONS} 
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Coverage
	${RM} dist/Coverage/GNU-Linux-x86/ncutilsc
